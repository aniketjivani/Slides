...
\title[Seminar]{Probabilistic Inference in NODEs}
...
\begin{frame}{Review: Combining GP and NODEs}
    
\end{frame}

\begin{frame}{Where existing works fall short}
    
\end{frame}

\begin{frame}{Scaling up GPs}
    Deep Kernel Learning?
\end{frame}

\begin{frame}{Producing (somewhat) calibrated uncertainties}

\end{frame}

\begin{frame}{Probabilistic Numerics?}
    Where does the uncertainty arise from?
    
\end{frame}

\begin{frame}{SPDE based approaches}
